(function() {
  var Analyser, CoffeeTouch, Drag, EventGrouper, EventRouter, FingerGesture, FirstTouch, Fixed, GenericState, NoTouch, StateMachine,
  ...
  Analyser = (function() {
    ...
    Analyser.prototype.init = function() {
      ...
      for (i = _i = 0, _ref = this.fingers.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    Analyser.prototype.triggerDrag = function() {
      if (CoffeeTouch.Helper.arrayContains(this.gestureName, "drag")) {
    ...
    Analyser.prototype.triggerDragDirections = function() {
      ...
      if (!CoffeeTouch.Helper.stringContains(gestureName, "unknown")) {
    ...
    Analyser.prototype.triggerPinchOrSpread = function() {
      ...
      if (this.informations.scale < 1.1 && !sameDirection) {
        this.targetElement.makeGesture("" + (CoffeeTouch.Helper.digit_name(this.fingers.length)) + ":pinch", this.informations);
        return this.targetElement.makeGesture("pinch", this.informations);
      } else if (this.informations.scale > 1.1 && !sameDirection) {
        this.targetElement.makeGesture("" + (CoffeeTouch.Helper.digit_name(this.fingers.length)) + ":spread", this.informations);
    ...
    Analyser.prototype.triggerFixed = function() {
      ...
      if (this.gestureName.length > 1 && CoffeeTouch.Helper.arrayContains(this.gestureName, "fixed")) {
        dontTrigger = false;
        gestureName = [];
        _ref = this.fingers;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    Analyser.prototype.triggerFlick = function() {
      ...
      if (CoffeeTouch.Helper.arrayContains(this.gestureName, "dragend")) {
        gestureName1 = [];
        gestureName2 = [];
        dontTrigger = false;
        _ref = this.fingers;
    ...
    Analyser.prototype.triggerRotation = function() {
      ...
      this.targetElement.makeGesture("" + (CoffeeTouch.Helper.digit_name(this.fingers.length)) + ":" + rotationDirection, this.informations);
      return this.targetElement.makeGesture("" + (CoffeeTouch.Helper.digit_name(this.fingers.length)) + ":rotate", this.informations);
    };
  ...
  Element.prototype.unbindGesture = function(ev, callback) {
    var callbackfunction, calls, i, list, _i, _len;
    if (!ev) {
      this._callbacks = {};
  ...
  Element.prototype.makeGesture = function(ev) {
    var callbacFunction, calls, list, _i, _j, _len, _len1;
  ...
  CoffeeTouch.Helper.stringContains = function(str1, str2) {
    return str1.indexOf(str2) !== -1;
  };

  CoffeeTouch.Helper.arrayContains = function(array, element) {
    var el, _i, _len;
  ...
  CoffeeTouch.Helper.mergeObjects = function(destination, source) {
    var property;
  ...
  CoffeeTouch.Helper.distanceBetweenTwoPoints = function(x1, y1, x2, y2) {
    return Math.sqrt(((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1)));
  };

  CoffeeTouch.Helper.getDirection = function(deltaX, deltaY) {
  ...
  CoffeeTouch.Helper.getDragDirection = function(finger) {
    var deltaX, deltaY;
    ...
    return CoffeeTouch.Helper.getDirection(deltaX, deltaY);
  };

  CoffeeTouch.Helper.digit_name = (function() {
    var names;
  ...
  GenericState = (function() {
    ...
    GenericState.prototype.apply = function(eventName, arg) {
      CoffeeTouch.Helper.mergeObjects(this.eventObj, arg);
  ...
  NoTouch = (function(_super) {
    __extends(NoTouch, _super);

    function NoTouch() {
      return NoTouch.__super__.constructor.apply(this, arguments);
    }
  ...
  FirstTouch = (function(_super) {
    __extends(FirstTouch, _super);

    function FirstTouch() {
      return FirstTouch.__super__.constructor.apply(this, arguments);
    }
  ...
  Fixed = (function(_super) {
    ...
    function Fixed() {
      return Fixed.__super__.constructor.apply(this, arguments);
    }
