(function() {
  ...
  */  var $, Drag, EventRouter, FirstTouch, FirstTouchDouble, Fixed, GenericState, NoTouch, NoTouchDouble, StateMachine;
  ...
  EventRouter = (function() {
    ...
    EventRouter.prototype.touchstart = function(event) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        i = _ref[_i];
        _results.push(!(this.machines[i.identifier] != null) ? (iMachine = new StateMachine(i.identifier, this), iMachine.apply("touchstart", i), this.machines[i.identifier] = iMachine, this.nbmachines++, this.analyser = new Analyser(this.nbmachines, this.element)) : void 0);
      }
      return _results;
    };
    EventRouter.prototype.touchend = function(event) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(!exists ? (this.machines[iMKey].apply("touchend", {}), delete this.machines[iMKey], this.nbmachines--) : void 0);
      }
      return _results;
    };
