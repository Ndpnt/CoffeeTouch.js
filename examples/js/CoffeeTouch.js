...
(function() {
  var Analyser, Analyzer, Drag, EventGrouper, EventRouter, FingerGesture, FirstTouch, Fixed, GenericState, NoTouch, StateMachine,
  ...
  FingerGesture = (function() {
    ...
    FingerGesture.prototype.update = function(gestureName, eventObj) {
      ...
      if (this.gestureName === "drag") {
        ...
        this.params.dragDirection = Analyzer.Helper.getDragDirection(this);
      }
  ...
  Analyzer.Helper.swapObject = function(obj1, obj2) {
    var temp;
    temp = obj2;
    obj2 = obj1;
    return obj1 = obj2;
  ...
  Analyzer.Helper.distanceBetweenTwoPoints = function(x1, y1, x2, y2) {
    return Math.sqrt(((x2 - x1) * (x2 - x1)) + ((y2 - y1) * (y2 - y1)));
  };

  Analyzer.Helper.getDirection = function(deltaX, deltaY) {
  ...
  Analyzer.Helper.getDragDirection = function(finger) {
    var deltaX, deltaY;
    ...
    return Analyzer.Helper.getDirection(deltaX, deltaY);
  };

  Analyzer.Helper.digit_name = (function() {
    var names;
  ...
  Analyser = (function() {
    ...
    Analyser.prototype.triggerPinchOrSpread = function() {
      ...
      if (this.informations.scale < 1.1 && !sameDirection) {
        this.targetElement.makeGesture("" + (Analyzer.Helper.digit_name(this.fingers.length)) + ":pinch", this.informations);
        return this.targetElement.makeGesture("pinch", this.informations);
      } else if (this.informations.scale > 1.1 && !sameDirection) {
        this.targetElement.makeGesture("" + (Analyzer.Helper.digit_name(this.fingers.length)) + ":spread", this.informations);
    ...
    Analyser.prototype.triggerRotation = function() {
      ...
      this.targetElement.makeGesture("" + (Analyzer.Helper.digit_name(this.fingers.length)) + ":" + rotationDirection, this.informations);
      return this.targetElement.makeGesture("" + (Analyzer.Helper.digit_name(this.fingers.length)) + ":rotate", this.informations);
    };
